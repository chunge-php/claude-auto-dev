...
- **自动分析项目** -- 识别技术栈、包管理器、代码风格、数据库、测试框架、i18n、认证方案、状态管理、API格式
...
| CI 反馈闭环 | push 后检查 GitHub Actions，失败自动修复（最多2轮） |
| 降级机制 | 错误频发/context紧张时自动简化流程 |
| 前端三态 | 新页面强制 Loading/Error/Empty 三种状态 |
